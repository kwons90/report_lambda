...
def generateReport():
    ...
    pdf.cell(0, 8, student_name +" Completed Session Review | Date: "+report_date, 0, 1, 'C')
...
#             print("else triggered")
    ...
    pdf.set_font('arial', 'B', 12)
    pdf.cell(0, 10, "Hi! Your child has just solved", 0, 1, "C")
    pdf.set_font("arial", '', 12)
    ...
    #add the graph
    pdf.image('./foo.png', x = 3, y = 163, w = 200, h = 0, type = '', link = '')
...
#     pdf.set_font('arial', '', 8)
    ...
    pdf.set_xy(0, 270)
    pdf.cell(0,5,"© 2023 - PrepAnywhere Inc. All Right Reserved.",0,1,"C")
    ...
    for i in range(0,len(imgl)):
        ...
        if(i%2 == 1):
            ...
            pdf.image(str(i)+".jpg", x=18, y=165, w=150, h=109.489)
        else:
            getImage(imgl[i], i)
            pdf.add_page()
            pdf.ln(5)
            ...
            if report1.session_data.accuracy[i] == 1:
                ...
                pdf.cell(10,7, " - Incorrect", 0, 0, "L")
            pdf.image(str(i)+".jpg", x=18, y=28, w=150, h=109.489)
            pdf.ln(60)
